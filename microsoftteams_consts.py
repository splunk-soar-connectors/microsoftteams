...
MSTEAMS_MSGRAPH_CHANNEL_SEND_MESSAGE_ENDPOINT = "/teams/{group_id}/channels/{channel_id}/messages"
MSTEAMS_MSGRAPH_CHAT_SEND_MESSAGE_ENDPOINT = "/chats/{chat_id}/messages"
MSTEAMS_MSGRAPH_GET_CHANNEL_MESSAGE_ENDPOINT = "/teams/{group_id}/channels/{channel_id}/messages/{message_id}"
MSTEAMS_MSGRAPH_GET_CHAT_MESSAGE_ENDPOINT = "/chats/{chat_id}/messages/{message_id}"
